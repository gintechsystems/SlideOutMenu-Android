...
import com.gintechsystems.slideoutmenu.SlideOutMenu.OnClosedListener;
import com.gintechsystems.slideoutmenu.SlideOutMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
    ...
    */
    ...
    protected int mTouchMode = SlideOutMenu.TOUCHMODE_MARGIN;
    ...
    private boolean thisTouchAllowed(MotionEvent ev) {
        ...
        if (isMenuOpen()) {
            ...
            switch (mTouchMode) {
                ...
                case SlideOutMenu.TOUCHMODE_NONE:
                    return false;
    ...
    public void scrollTo(int x, int y) {
        ...
        //((SlideOutMenu)getParent()).manageLayers(getPercentOpen());
    }
